  ...
  - type: GenericSection
    ...
    actions:
      - label: Contattami
        ...
        elementId: ''
        type: Button
      - label: Contattami con freccia a destra
        altText: ''
        url: /
        showIcon: true
        icon: arrowRight
    ...
    media:
      ...
      type: ImageBlock
    badge:
      label: nessuno leggi i curriculum
      color: text-primary
      type: Badge
    elementId: ''
  ...
  - type: FeaturedItemsSection
    title:
      ...
      styles:
        self:
          textAlign: center
      type: TitleBlock
    subtitle: Suggeritemi un sottotitolo
    items:
      - type: FeaturedItem
      ...
      - title: Sicurezza sul lavoro
        ...
        styles:
          self:
            ...
            justifyContent: center
        type: FeaturedItem
      - title: Corso di cucina con mia sorella
        subtitle: Faster
        text: >-
          Sed ut perspiciatis unde omnis iste natus error sit voluptatem
          accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae.
    ...
    actions:
      - label: Contattami
        ...
        type: Button
    badge:
      label: Questa e' la prima sezione
      color: text-primary
      styles:
        self:
          textAlign: center
